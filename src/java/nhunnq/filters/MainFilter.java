...
public class MainFilter implements Filter {
    ...
    private final String SHOW_TOUR_SERVLET ="ShowToursServlet";
        ...
        try {
            ...
            if(resource.length() > 0){
                if(resource.lastIndexOf(".html") > 0 || resource.lastIndexOf(".jsp") > 0){
                    ...
                    url = resource;
                }else if(resource.lastIndexOf(".jpg") > 0|| resource.lastIndexOf(".png") > 0){
                    url = resource;
                } else{
            ...
            log("MainFilter_Exception: " + e.getMessage());
        }
    }
